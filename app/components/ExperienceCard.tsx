...
const ExperienceCard: React.FC<ExperienceCardProps> = ({
    ...
    return (
        ...
        >
            {/* Título */}
            <h3 className="text-lg md:text-xl  font-[Orbitron]  font-semibold neon-text-white flex items-center gap-3 sm:gap-4">
                <FaBuilding className="w-5 h-5 sm:w-6 sm:h-6 text-ciberpink flex-shrink-0" />
                {role} en {company}
            </h3>

            {/* Fechas */}
            <p className="mt-2 text-gray-300 font-[Inter] text-sm md:text-base flex items-center gap-3 sm:gap-4">
            ...
            {/* Logros */}
            <ul className="mt-4 text-gray-300 font-[Inter] text-sm md:text-base list-disc list-inside space-y-2">
